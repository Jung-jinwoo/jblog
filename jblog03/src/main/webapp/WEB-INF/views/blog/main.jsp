	...
	<div id="container">
		<div id="wrapper">
			<div id="content">
				...
				<ul class="blog-list">
					<li><a href="">아라라라라라라</a> <span>2015/05/02</span></li>
					<li><a href="">에베베베베베벱</a> <span>2015/05/02</span></li>
					<li><a href="">크크크크크크크</a> <span>2015/05/02</span></li>
					<li><a href="">루루루루루ㅜ룰</a> <span>2015/05/02</span></li>
					<li><a href="">삥삥삥뽕뽕뽕</a> <span>2015/05/02</span></li>
				</ul>
			</div>
		</div>
		...
		<div id="extra">
			<div class="blog-logo">
				<img
					src="${pageContext.request.contextPath}/${blog.logo}">
			</div>
		</div>
